...
import SpringTrainingCode.exceptions.AccountNotFoundException;
import SpringTrainingCode.exceptions.ClientNotFoundException;
...
public class BankingImpl implements Banking{
    ...
    public void removeClient(Client client) {
        repository.remove(client.getId());
    }
